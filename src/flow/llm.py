...
#
# 240 → 480 (2026-08-24). 240 은 "정상 최대 166초"(v200 comp16) 기준이었는데 그 뒤
# select_clips 의 정상 소요가 올라 경계선에 걸렸다 — comp38 은 226초로 간신히 완주하고
# comp39·40 은 넘겨서 **편성 전체 소요의 96%가 버려진 대기**가 됐다(240초 태우고 빈
# 응답 → 재시도 1.3초). 인벤토리가 85장면·9,900자로 커진 게 원인이라 상한을 올린다.
# 480 은 진짜 교착(804초)은 여전히 끊는 자리다 — 가드를 없애는 게 아니라 옮기는 것.
#
